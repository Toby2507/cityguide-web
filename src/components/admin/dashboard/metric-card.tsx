...
const MetricCard = ({ id, title, value, href, Icon }: IMetricCard) => {
  return (
    <article className="flex-1 flex flex-col border border-accentLightBlue rounded-t-2xl">
      <div className="flex items-center gap-4 p-3">
        <div className="grid place-items-center bg-accentLightBlue h-12 w-12 rounded-lg">
      ...
      <div className="flex flex-col -mt-4">
        ...
        <button className="text-white text-sm tracking-wide bg-accentLightBlue -mt-5 rounded-t-2xl pb-2">
          View Details
        </button>
      </div>
    </article>
