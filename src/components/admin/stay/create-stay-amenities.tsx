...
interface ICreateStayAmenities {
  amenities: string[];
  label: string;
  customStyle?: string;
...
const CreateStayAmenities = ({ amenities, label, customStyle, setAmenities }: ICreateStayAmenities) => {
...
export default CreateStayAmenities;
