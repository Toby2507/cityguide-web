const path = {
  ...
  airtime: () => '/airtime',
  airtimeDashboard: () => '/airtime/dashboard',
  airtimeHistory: () => '/airtime/dashboard/history',
  airtimeReceivers: () => '/airtime/dashboard/receivers',
  airtimePurchaseAirtime: () => '/airtime/dashboard/purchase/airtime',
  airtimePurchaseData: () => '/airtime/dashboard/purchase/data',
